...
class BPSConfig:
    ...
    val_meta_fname:     str = 'meta_dose_hi_hr_4_post_exposure_valid.csv'
    save_dir:           str = os.path.join(root, 'src', 'models', 'lenet')
    batch_size:         int = 16
    max_epochs:         int = 10
...
def main():
    ...
    config = BPSConfig(data_dir=os.path.join(root, 'data', 'processed'))
